...
for subji=1:length(subj_list)
    ...
    for sess_iter = 1:length(sess_lists)
        ...
        clear matlabbatch func_folder_path func_data anat_folder_path anat_data
...
%   Remove the variables repeating or not necessary
clear tStart func_data_full_name anat_data_full_name tEnd file_ID content_format
